...
package Friction "Friction models"
  ...
  package Friction1DFEM
  extends Modelica.Icons.Package;

    model NoFriction "No friction is applied"
      extends ThermoPower.Friction.Interfaces.FrictionBase1DFEM;
    ...
    equation
      NoFriction = false;
      Kf = fill(dpnom*rhonom/(wnom/Nt)^2*Kfc, N);
      Cf = 2*Kf*A^3/(omega_hyd*L);
  ...
  extends ThermoPower.Friction.Interfaces.FrictionBase1DFEM;
    ...
    equation
      ...
      annotation(
        Documentation(info = "<html><head></head><body><p>This friction model can be used with the <code>Fow1DFEM</code> model in the <code>FluidPh</code> package.</p><p>Fanning friction factor is computed by Colebrook's equation (assuming Re > 2100, e.g. turbulent flow).</p></body></html>", revisions = "<html><head></head><body><ul>
            <li><i>18 Mar 2026</i>
            by <a href=\"mailto:andrea.bartolini@dynamica-it.com\">Andrea Bartolini</a>:<br>
               First release.</li>
            </ul>
...
<li><i>15 Oct 2025</i>
    ...
    partial model FrictionBase1DFEM "Friction base model for 1DFEM components"
      replaceable package Medium = Modelica.Media.Interfaces.PartialMedium "Medium model"
        constrainedby Modelica.Media.Interfaces.PartialMedium
        annotation(choicesAllMatching = true);
      ...
      annotation(
        Documentation(info = "<html><head></head><body>Base model for <code>replaceable</code> friction models to be used to <code>redeclare</code> the fricion model in the <code>Flow1DFEM</code> components;</body></html>", revisions = "<html><head></head><body><ul>
    <li><i>18 Mar 2025</i>
        by <a href=\"mailto:andrea.bartolini@dynamica-it.com\">Andrea Bartolini</a>:<br>
           First release.</li>
    </ul>
