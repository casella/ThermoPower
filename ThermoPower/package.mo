...
This package contains general-purpose functions and models
  ...
  package Electrical "Simplified models of electric power components"
    ...
    model Grid "Ideal grid with finite droop"
      ...
      PowerConnection connection annotation (Placement(transformation(extent={{
    ...
    equation
      ...
      annotation (Diagram(graphics),
          ...
          Line(points={{-72,0},{-40,0}}, color={0,0,0}),
          Ellipse(
            extent={{100,-68},{-40,68}},
            lineColor={0,0,0},
            lineThickness=0.5),
    ...
    initial equation
      ...
      annotation (Icon(graphics={
          ...
          Ellipse(
            ...
            fillColor={255,255,255},
            fillPattern=FillPattern.Solid),
          Line(points={{50,0},{72,0}}, color={0,0,0}),
          Text(
            extent={{-26,24},{28,-28}},
            lineColor={0,0,0},
            fillColor={255,255,255},
...
<p>It is possible to consider the generator inertia in the model, by setting the parameter <tt>J > 0</tt>. 
    ...
    model Breaker "Circuit breaker"
      PowerConnection connection1 annotation (Placement(transformation(extent={
              {-100,-14},{-72,14}}, rotation=0)));
    ...
    equation
      ...
      annotation (Diagram(graphics),
                           Icon(graphics={
          Line(points={{-72,0},{-40,0}}, color={0,0,0}),
          Line(points={{40,0},{72,0}}, color={0,0,0}),
          Line(
...
Ideal breaker model. Can only be used to connect a generator to a grid with finite droop. Otherwise, please consider the other models in this package.
    ...
    equation
      ...
      annotation (
        ...
        rotation=-90,
        Icon(graphics={
          Line(points={{0,40},{0,74}}, color={0,0,0}),
          Rectangle(
            extent={{-20,40},{20,-40}},
            lineColor={0,0,0},
            lineThickness=0.5,
            fillColor={255,255,255},
            fillPattern=FillPattern.Solid),
          Line(points={{0,-40},{0,-68}}, color={0,0,0}),
          Line(points={{16,-68},{-16,-68}}, color={0,0,0}),
          Line(points={{8,-76},{-8,-76}}, color={0,0,0}),
          Line(points={{-2,-84},{4,-84}}, color={0,0,0})}),
      Diagram(graphics),
    ...
    model PowerSensor "Measures power flow through the component"
      PowerConnection port_a annotation (Placement(transformation(extent={{-110,
              -10},{-90,10}}, rotation=0)));
    ...
    equation
      ...
      annotation (Icon(graphics={
          Line(
            ...
            color={0,0,0},
            thickness=0.5),
          Line(points={{-56,0},{-98,0}}, color={0,0,0}),
          Line(points={{-34,0},{-16,0},{12,16}}, color={0,0,0}),
          Line(points={{14,0},{40,0}}, color={0,0,0}),
          Rectangle(
            extent={{-60,6},{-34,-6}},
            lineColor={0,0,0},
            fillColor={255,255,255},
    ...
    equation
      ...
      annotation (Icon(graphics={
          Rectangle(
            ...
            fillColor={255,255,255},
            fillPattern=FillPattern.Solid),
          Line(points={{-54,0},{-92,0}}, color={0,0,0}),
          Line(points={{-28,0},{-10,0},{18,16}}, color={0,0,0}),
          Line(points={{20,0},{46,0}}, color={0,0,0}),
          Line(
            points={{46,40},{46,-40}},
            color={0,0,0},
...
Casella</a> and <a> Luca Savoldelli </a>:<br>
       First release.</li>
          ...
          Line(points={{-54,0},{-94,0}}, color={0,0,0}),
          Line(points={{62,0},{98,0}}, color={0,0,0}),
          Line(points={{-34,0},{-14,0},{12,18}}, color={0,0,0}),
          Line(points={{14,0},{38,0}}, color={0,0,0}),
          Rectangle(
            extent={{-58,6},{-34,-6}},
            lineColor={0,0,0},
            fillColor={255,255,255},
...
Casella</a> and <a> Luca Savoldelli </a>:<br>
       First release.</li>
          ...
          Line(points={{-54,0},{-94,0}}, color={0,0,0}),
          Line(points={{56,0},{92,0}}, color={0,0,0}),
          Line(points={{-34,0},{-14,0},{12,18}}, color={0,0,0}),
          Line(points={{14,0},{38,0}}, color={0,0,0}),
          Rectangle(
            extent={{-58,6},{-34,-6}},
  ...
  protected
    ...
    initial equation
      ...
      annotation (Diagram(graphics),
                           Icon(graphics={
          Line(points={{32,0},{98,0}}, color={0,0,0}),
          Line(points={{-40,0},{-32,0},{-16,8}}, color={0,0,0}),
          Line(points={{-16,0},{16,0}}, color={0,0,0}),
          Line(points={{0,2},{0,12},{8,24}}, color={0,0,0}),
          Line(
            points={{-30,64},{30,64}},
            color={0,0,0},
            thickness=0.5),
          Line(points={{0,64},{0,26}}, color={0,0,0}),
          Rectangle(
            extent={{-4,54},{4,36}},
            lineColor={0,0,0},
            fillColor={255,255,255},
          ...
          Ellipse(
            ...
            fillColor={0,0,0},
            fillPattern=FillPattern.Solid),
          Line(points={{-36,0},{-102,0}}, color={0,0,0}),
          Rectangle(
            extent={{-66,4},{-48,-4}},
            lineColor={0,0,0},
            fillColor={255,255,255},
          ...
          Rectangle(
            ...
            fillColor={255,255,255},
            fillPattern=FillPattern.Solid),
          Line(points={{8,0},{16,0},{32,8}}, color={0,0,0})}),
        Documentation(info="<html>
